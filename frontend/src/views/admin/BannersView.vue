<template>
    <div class="w-full">
        <Sidebar link="banners" />
        <div class="p-4 sm:ml-64">
            <div class="w-full mt-10">
                <h2 class="text-blue-700 text-lg m-2">Banners</h2>
            ...
            <div class="w-full">
                <form @submit.prevent="addBanner" class="max-w-lg mx-auto bg-slate-100 py-10 px-10 rounded-xl">
                    <div class="mb-5">
                        ...
                        <div class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="brand_img_help">For this banner
                            picture</div>
                    </div>
                    <button type="submit"
    ...
    methods: {
        ...
        async addBanner() {
            try {
                ...
                let toast = useToast();
                if (banner.data.status === 201) {
                    toast.success(banner.data.msg);
                }
                await this.allBanners()
            } catch (error) {
                let toast = useToast();
