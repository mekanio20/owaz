    ...
    <div class="container py-5">
        <div class="flex items-center justify-between">
            <router-link to="/" class="flex items-center space-x-4">
                ...
                <h1 class="font-poppins font-semibold md:text-xl sm:text-lg text-base text-m_red-100 text-nowrap">Owaz
                    Store</h1>
            </router-link>
            ...
            <div class="md:flex items-center space-x-6 hidden">
                <svg class="md:w-[24px] w-[20px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div @click="openBurger" class="cursor-pointer md:hidden">
                <div class="w-10 flex flex-col justify-between space-y-2">
                    <div class="h-0.5 bg-m_red-100 duration-500"
                        :class="[isBurger ? 'w-6 transform translate-y-[10px] -rotate-45' : 'w-6']"></div>
                    <div class="w-3 h-0.5 bg-m_red-100 duration-500" :class="[isBurger ? 'opacity-0' : '']"></div>
                    <div class="h-0.5 bg-m_red-100 duration-500"
